(function (blocks, editor, components, i18n, element) {
  ...
  registerBlockType('schutzteufel/profile-block', { // The name of our block. Must be a string with prefix. Example: my-plugin/my-custom-block.
    ...
    attributes: { // Necessary for saving block content.
      ...
      bio: {
        type: 'string',
        source: 'html',
        selector: '.schutzteufel-profile-bio'
      },
      mediaID: {
        type: 'number'
      },
    ...
    edit: function (props) {
      ...
      return [
        ...
        el('div', { className: props.className },
          el('div', {
            className: attributes.mediaID ? 'schutzteufel-profile-image image-active' : 'schutzteufel-profile-image image-inactive',
          ...
          el('div', { className: 'schutzteufel-profile-content', style: { textAlign: alignment } },
            ...
            el('div', { className: 'schutzteufel-profile-social' },
    ...
    save: function (props) {
      ...
      return (
        el('div', { className: props.className },
          attributes.mediaURL && el('div', { className: 'schutzteufel-profile-image', style: { backgroundImage: 'url(' + attributes.mediaURL + ')' } },
